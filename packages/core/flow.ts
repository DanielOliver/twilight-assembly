import { GameCreationDraftType, GameCreationState } from "./types/engine";
...
export class GameCreation {
  ...
  get state(): GameCreationState {
    return this._state;
  }
  get draftType(): GameCreationDraftType {
    return this._draftType;
  }
  get participants(): string[] {
    return this._participants;
  }
  get mapTtsString(): string {
    return this._mapTtsString;
  }
  get availableDraftTypes(): AvailableDraftType[] {
    let results: AvailableDraftType[] = [];
    results.push(
      new AvailableDraftType(
